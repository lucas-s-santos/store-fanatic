/**
 * Script: upload-premier.mjs
 * Faz upload das imagens da Premier League para o Cloudinary e cria os produtos no Supabase.
 *
 * Como rodar:
 *   node scripts/upload-premier.mjs
 */
...
const BASE_FOLDER   = 'premier-league'
const IMAGES_ROOT   = join(__dirname, '..', 'public', 'Premier league')
const MAP_OUTPUT    = join(__dirname, '..', 'cloudinary-map-premier.json')
const CONCURRENT    = 5
...
const TEAM_MAP = {
  ...
  'Aston Villa':       { id: 'aston-villa',       name: 'Aston Villa' },
  'Brighton':          { id: 'brighton',          name: 'Brighton' },
  'Chelsea':           { id: 'chelsea',           name: 'Chelsea' },
  'Crystal Palace':    { id: 'crystal-palace',    name: 'Crystal Palace' },
  'Everton':           { id: 'everton',           name: 'Everton' },
  'Fulham':            { id: 'fulham',            name: 'Fulham' },
  'Leeds United':      { id: 'leeds-united',      name: 'Leeds United' },
  'Leicester City':    { id: 'leicester-city',    name: 'Leicester City' },
  'Liverpool':         { id: 'liverpool',         name: 'Liverpool' },
  'Manchester City':   { id: 'manchester-city',   name: 'Manchester City' },
  'Manchester United': { id: 'manchester-united', name: 'Manchester United' },
  'Newcastle':         { id: 'newcastle',         name: 'Newcastle' },
  'Nottingham Forest': { id: 'nottingham-forest', name: 'Nottingham Forest' },
  'Sheffield United':  { id: 'sheffield-united',  name: 'Sheffield United' },
  'Tottenham':         { id: 'tottenham',         name: 'Tottenham' },
  'West Ham':          { id: 'west-ham',          name: 'West Ham' },
}
...
async function main() {
  ...
  console.log('🔍 Listando imagens em public/Premier league...')
  ...
  console.log(`📄 Mapa salvo em: cloudinary-map-premier.json\n`)
