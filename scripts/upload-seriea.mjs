/**
 * Script: upload-seriea.mjs
 * Faz upload das imagens da Serie A para o Cloudinary e cria os produtos no Supabase.
 *
 * Como rodar:
 *   node scripts/upload-seriea.mjs
 */
...
const BASE_FOLDER   = 'serie-a'
const IMAGES_ROOT   = join(__dirname, '..', 'public', 'Serie A')
const MAP_OUTPUT    = join(__dirname, '..', 'cloudinary-map-seriea.json')
const CONCURRENT    = 5
...
const TEAM_MAP = {
  'Atalanta':       { id: 'atalanta',    name: 'Atalanta' },
  'Empoli':         { id: 'empoli',      name: 'Empoli' },
  'Fiorentina':     { id: 'fiorentina',  name: 'Fiorentina' },
  'Inter de Milão': { id: 'inter-milan', name: 'Inter de Milão' },
  'Juventus':       { id: 'juventus',    name: 'Juventus' },
  'Lazio':          { id: 'lazio',       name: 'Lazio' },
  'Milan':          { id: 'milan',       name: 'Milan' },
  'Napoli':         { id: 'napoli',      name: 'Napoli' },
  'Roma':           { id: 'roma',        name: 'Roma' },
  'Sampdoria':      { id: 'sampdoria',   name: 'Sampdoria' },
}
...
async function main() {
  ...
  console.log('🔍 Listando imagens em public/Serie A...')
  ...
  console.log(`📄 Mapa salvo em: cloudinary-map-seriea.json\n`)
